        ...
        const filteredPositions =
          data
            ...
            .map((p: any) => {
              ...
              const entryPrice = Number.parseFloat(p.avgPx || "0");
              const markPrice = Number.parseFloat(p.markPx || "0");
              ...
              const result = {
                ...
                liqPrice: Number.parseFloat(p.liqPx || "0"),
                unrealisedPnl: Number.parseFloat(p.upl || "0").toString(),
                realisedPnl: Number.parseFloat(p.realizedPnl || "0").toString(),
                margin: marginValue.toString(),
                notionalUsd: p.notionalUsd,
                positionId: gateContract,
                positionAmt: size,
                pnlPercent,
                id: gateContract,
                liq_price: Number.parseFloat(p.liqPx || "0"),
                symbol: gateContract?.split("_")[0],
