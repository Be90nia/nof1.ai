...
export function checkCaisenAddPositionConditions(
	...
	const avgEntryPrice = position.average_entry_price || position.entry_price;
	const currentDrop = (avgEntryPrice - addPrice) / avgEntryPrice;
